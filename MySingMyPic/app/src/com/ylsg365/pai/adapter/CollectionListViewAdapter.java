...
public class CollectionListViewAdapter extends RecyclerView.Adapter<CollectionListViewAdapter.ViewHolder> {
    ...
    Context context;
    public CollectionListViewAdapter(Context context,int layoutResId, List<JSONObject> list) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        String str= JsonUtil.getString(infoJsonObject, "ndesc");
        ...
        if(holder.shareLayout!=null)
            holder.shareLayout.setVisibility(View.GONE);
        if( holder.collectionCountTextView != null){
        	holder.collectionCountTextView.setText("");
        }

        if(JsonUtil.getBoolean(infoJsonObject, "isCollection")==true)
        	holder.imgCollection.setImageDrawable(context.getResources().getDrawable(R.drawable.img_keep_p));
        else holder.imgCollection.setImageDrawable(context.getResources().getDrawable(R.drawable.img_keep_n));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            imgCollection=(ImageView)itemView.findViewById(R.id.img_collectionCount);
