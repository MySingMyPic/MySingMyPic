 ...
 * 音乐调节
 */
public class Music_Intervention_fullActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music__intervention_full);
        ...
        rightTextView.setBackgroundDrawable(getResources().getDrawable(R.drawable.yuanchang));
        rightTextView.setTag("on");
        rightTextView.setVisibility(View.VISIBLE);
        rightTextView.setText("");
        rightTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if("on".equals(v.getTag())){
                    v.setTag("off");
                    v.setBackgroundDrawable(getResources().getDrawable(R.drawable.banchang));
                }else{
                    v.setTag("on");
                    v.setBackgroundDrawable(getResources().getDrawable(R.drawable.yuanchang));
                }
            }
        });
